...
def viewwindow():
    ...
    for row in viewallusers():
        ...
        for i in range (f):
            c= c + "*"
        d = a + "         " + b + "           " + c
        Message(gui,fg='#b4b387',font=("adobe clean", 25, "bold"),text = d,width=700).pack()
...
def appwindow():
    ...
    def endpage():
        ...
        Label(gui,font=("ink free",35),bg="#bfbfbf",text="Expense tracker").place(x=500,y=450)
    ...
    l7=Label(gui,width=100,height=10,font=("century",35),bg="#9999ff",text="").place(x=-455,y=410)
    ...
    b7=Button(gui,text="Close app",font=("georgia",17),activebackground="#751aff",activeforeground="red",width=10,command=endpage).place(x=700,y=650)
...
frame = Frame(bd=0, highlightthickness=0, background="#751aff").place(relx=0.49, y=0, relwidth=1, relheight=1)
...
l6=Label(root,font=("comic sans ms",19),bg="#751aff",text="Name").place(x=540,y=195)
l3=Label(root,font=("comic sans ms",19),bg="#751aff",text="Username").place(x=540,y=243)
l4=Label(root,font=("comic sans ms",19),bg="#751aff",text="Password").place(x=540,y=293)
l5=Label(root,font=("comic sans ms",17),bg="#751aff",text="Confirm password").place(x=540,y=342)
...
Label(root,width=78,font=("jokerman",32),bg="#00cde1",fg="#cc2900",text="EXPENSE  TRACKER").place(x=-450,y=0)
Label(root,font=("Ink Free",27),bg="#33cccc",fg="#0000ff",text="Expense Tracker").place(x=715,y=650)
b3=Button(root,text="Exit Window",font=("candara",15,"bold"),activebackground="#fffa66",activeforeground="red",width=10,command=root.destroy).place(x=450,y=630)
